...
description: "Spatial Shanghai 2026 推荐开发环境——在 PyCharm 中使用 Claude Code 终端，通过 Z.AI API 驱动。"
---
...
许可证服务器（`jetbrains.ritsdev.top`）仅在 NYU 网络内可访问。在激活 PyCharm 之前，请确保你已连接到以下其中一项：

- 校园内的 **nyu** Wi-Fi
- 校外使用 **NYU VPN** — 可从 [nyu.edu/life/information-technology/getting-started/network-and-connectivity/vpn.html](https://www.nyu.edu/life/information-technology/getting-started/network-and-connectivity/vpn.html) 下载

> 只有在激活步骤时才需要连接 NYU 网络。激活完成后，PyCharm 可在任意网络环境下正常使用。

---

## 第一步：下载并激活 PyCharm

1. 从 [jetbrains.com/pycharm](https://www.jetbrains.com/pycharm/) 下载 PyCharm 并安装。
2. 打开 PyCharm。在欢迎界面点击 **Unlock Pro Features**（如果已进入 IDE，则前往 **Help > Register**）。
3. 选择 **Activate License**（激活许可证）。
4. 选择 **License Server**（许可证服务器）。
5. 输入以下地址：
   ```
   https://jetbrains.ritsdev.top
   ```
6. 点击 **Activate**（激活）——许可证将立即生效。
...
- [PyCharm 下载](https://www.jetbrains.com/pycharm/) — 下载 PyCharm
