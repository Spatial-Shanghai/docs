...
5. 从 [jetbrains.com/products](https://www.jetbrains.com/products/) 下载你的 IDE。

### 通过许可证服务器激活

安装并打开 PyCharm 后，可以使用黑客松许可证服务器进行激活：

1. 在欢迎界面点击 **Unlock Pro Features**（如果已进入 IDE，则前往 **Help > Register**）。
2. 选择 **Activate License**（激活许可证）。
3. 选择 **License Server**（许可证服务器）。
4. 输入以下地址：
   ```
   https://jetbrains.ritsdev.top
   ```
5. 点击 **Activate**（激活）——许可证将立即生效。
